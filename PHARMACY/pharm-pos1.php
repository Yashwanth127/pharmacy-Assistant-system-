...
<body>
	...
	<?php
		...
		if(isset($_POST['add'])) {
				...
				echo "<div style='width:100%; display:flex; justify-content:center; margin-top:20px;'>";
echo "<a class='button1 view-btn' href='pharm-pos2.php?sid=".$sid."' style='padding:12px 24px; background-color:#28a745; color:white; text-decoration:none; border-radius:5px; font-size:16px; font-weight:bold; text-align:center;'>View Order</a>";
echo "</div>";
